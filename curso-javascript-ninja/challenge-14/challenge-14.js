...
console.log( '\nJust Numbers:' );
// ?
let justNumbers = numberObjects.map(function(item, index, array){
    return item.number;
});
...
// ?
let justMod2Or3 = justNumbers.filter(function(item,index,array){
...
console.log(inversedName.toString());
