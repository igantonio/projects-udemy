...
let operation = {sum: '+', subtraction: '-', multiplcation: '*', division: '/', mod: '%'};
...
function isOperatorValid(operador){
    return operador === operation.sum || 
            operador === operation.subtraction ||
            operador === operation.multiplcation ||
            operador === operation.division ||
            operador === operation.mod
            ? true : false;
}
...
function showOperationMessage(operador, num1, num2){
    let calculadora = calculator(operador);
    return 'A operação ' + num1 +  ' ' + operador + ' ' + num2 + ' = ' + calculadora(num1, num2);
}
...
if(sum){
    ...
    console.log('showOperationMessage: ' + showOperationMessage(operationSignal, number1, number2));
    console.log('sum: ' + sum(number1, number2));
}
...
if(mod){
    ...
    console.log('showOperationMessage: ' + showOperationMessage(operationSignal, number1, number2));
    console.log('mod: ' + mod(number1, number2));
}
