...
function calculator(num1, num2){
    return function (callback){
        ...
        return 'Resultado da operação: ' + num1 + ' ' + callback + ' ' + num2 +' = ' + result +'.';
    }
}
...
let subtraction = calculator(2,5);
let multiplication = calculator(2,5);
let division = calculator(2,5);
let mod = calculator(2,5);
